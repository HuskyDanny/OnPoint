---
name: verboseless
description: Detail less, say less. Big idea first, then the one next action, in terse prose. Substance never compressed. Use when the user says "verboseless", "be terse", "abstract first", "say less", "next action first", or asks for less verbose output.
---
